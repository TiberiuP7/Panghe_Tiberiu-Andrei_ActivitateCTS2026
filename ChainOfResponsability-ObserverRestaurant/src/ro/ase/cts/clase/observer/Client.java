...
public class Client implements Observer {
    ...
    public void primesteSMS(String mesaj) {
        System.out.println("Notificare SMS catre clientul " + this.nume + " cu mesajul: " + mesaj);
    }

    @Override
    public void primesteEmail(String mesaj) {
        System.out.println("Notificare Email catre clientul " + this.nume + " cu mesajul: " + mesaj);
    }
}
